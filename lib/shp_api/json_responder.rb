module ShpApi
  class JsonResponder
    ...
    def unauthorized(message: "Unauthorized", error_code: "unauthorized")
      @controller.render partial: "shp_api/error", locals: { message: message, error_code: error_code }, status: 401
      return false
    end
    ...
    def error(message: "Not specified", error_code: "not_specified", status: 400)
      @controller.render partial: "shp_api/error", locals: { message: message, error_code: error_code }, status: status
      return false
    end
    ...
    def forbidden(exception: nil, error_code: "forbidden")
      msg = exception ? exception.message : "Forbidden"
      @controller.render partial: "shp_api/error", locals: { message: msg, error_code: error_code }, status: 403
      return false
    end
    ...
    def not_found(exception: nil, error_code: "not_found")
      msg = exception ? exception.message : "Not Found"
      @controller.render partial: "shp_api/error", locals: { message: msg, error_code: error_code }, status: 404
      return false
    end
